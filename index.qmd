...
We provide training workshops in data science, coding/programming, use of HPC and best practices. These workshops are available either as part of our training programme, or via partnerships with CDTs or DTPs at the University.

Our training workshops receive consistently [great feedback from attendees](https://www.bristol.ac.uk/acrc/research-software-engineering/training/training-feedback/). Our materials are also available online as both self-led courses and pre-recorded videos via the links below. We also link to some external courses, where we think these would be valuable to the University of Bristol community.
...
[Beginning Python](#python) - **2 October 1-4pm ONLINE**  
[Enroll Beginning Python](https://events.teams.microsoft.com/event/0e96f288-95b1-4b5e-b943-46cf1936cda5@b2e47f30-cd7d-4a4e-a5da-b18cf1a4151b){.btn .btn-primary}

[Intermediate Python](#python) - **9 October 1-4pm ONLINE**  
[Enroll Intermediate Python](https://events.teams.microsoft.com/event/f24cd6ff-26f8-40d6-a010-a87f4f40871d@b2e47f30-cd7d-4a4e-a5da-b18cf1a4151b){.btn .btn-primary}


## Mailing list

:::{.callout-note}
We are changing the name of our mailing list. It will shortly change to <bristol-research-computing-training@jiscmail.ac.uk>, so if you come back to this page in a few days, these instructions will change.
:::

Our **training alerts mailing list** sends updates on when we are teaching the courses.

[Join the training alerts mailing list](mailto:LISTSERV@jiscmail.ac.uk?body=SUBSCRIBE acrc-training-alerts){.btn .btn-primary}
...
If you have any feedback or suggested topics for training (including bespoke training sessions), please contact us on: <jgi-training@bristol.ac.uk>.
